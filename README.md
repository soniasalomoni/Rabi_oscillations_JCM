...
- An important example occurs when two-state atoms encounter a cavity maintained at a finite temperature <img src="https://latex.codecogs.com/svg.image?T">, so that the photon number distribution is that of one mode of black-body radiation, given by the **Bose-Einstein probability distribution:**
